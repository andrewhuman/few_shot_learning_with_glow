...
class Glow(nn.Module):
    ...
    def __init__(self, hparams,test_class_index,is_mean = False ,K = 3,y_classes = 80,is_split_2d = False,is_prior_total= False,is_prior_wh= False,z_add_random = True,arc_loss = False):
        ...
        if hparams.Glow.y_condition:
            ...
            if self.arc_loss :
                self.metric_fc = ArcMarginProduct(self.C_project_class // 2, self.y_classes, s=30, m=0.5)
            else:
